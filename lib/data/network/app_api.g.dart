...
// ignore_for_file: unnecessary_brace_in_string_interpolations,no_leading_underscores_for_local_identifiers,unused_element,unnecessary_string_interpolations,unused_element_parameter
...
class _AppServicesClient implements AppServicesClient {
  ...
  @override
  Future<VerifyResponse> verifyOtp(String phone, String code) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<RequestSiteSurveyResponse> requestSiteSurvey(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RequestSiteSurveyResponse _value;
    try {
      _value = RequestSiteSurveyResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<UploadMediaResponse> uploadMedia(List<MultipartFile> files) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UploadMediaResponse _value;
    try {
      _value = UploadMediaResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<void> rescheduleAppointment(String scheduleDate) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(<String, dynamic>{'schedule_date': scheduleDate});
    final _options = _setStreamType<void>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<NextAppointmentResponse> getNextAppointment() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;

    final _options = _setStreamType<NextAppointmentResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/next-appointment',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late NextAppointmentResponse _value;

    try {
      _value = NextAppointmentResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<LibraryResponse> getLibrary() async {
    ...
    final _options = _setStreamType<LibraryResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/library',
    ...
    late LibraryResponse _value;
    try {
      _value = LibraryResponse.fromJson(_result.data!);
    } catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ContractsStatusResponse> getContractsStatus() async {
    ...
    final _options = _setStreamType<ContractsStatusResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/user/contracts',
    ...
    late ContractsStatusResponse _value;
    try {
      _value = ContractsStatusResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
