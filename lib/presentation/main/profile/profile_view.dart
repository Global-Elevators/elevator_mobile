...
class _ProfileViewState extends State<ProfileView> {
  late List<ProfileItemWidget> firstItems = [
    ...
    ProfileItemWidget(IconAssets.language, Strings.language, () {}),
  ];
  ...
  late List<ProfileItemWidget> secondItems = [
    ...
    ProfileItemWidget(IconAssets.signOut, Strings.signOut, () {}),
  ];
...
class ProfileItemWidget extends StatelessWidget {
  ...
  SvgPicture itemIcon(String image) => SvgPicture.asset(
    image,
